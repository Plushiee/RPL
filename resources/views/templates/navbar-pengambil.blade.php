            ...
            <ul class="list-unstyled topnav-menu float-right mb-0">
                <li class="dropdown notification-list">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                        ...
                        <!-- item-->
                        <a href="/pengambil/logout" class="dropdown-item notify-item">
                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <li><a href="/pengambil/dashboard"
                                    class="mt-0 @if (request()->is('pengambil/dashboard')) active-class active-txt @endif"><i
                    ...
                    <li class="@if (request()->is('pengambil/pembayaran*')) active-class @endif">
                    ...
                    <li class="@if (request()->is('pengambil/riwayat*')) active-class @endif">
                    ...
                    <li class="@if (request()->is('pengambil/akun*')) active-class @endif">
                        <a href="/pengambil/akun">
                            <i
                                class="mdi mdi-settings-outline noti-ico @if (request()->is('pengambil/akun*')) active-txt @endif"></i>
                            <span class="@if (request()->is('pengambil/akun*')) active-txt @endif"> Akun </span>
                        </a>
                    </li>
                </ul>
