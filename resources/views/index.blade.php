        ...
        <nav class="navbar navigation__transparent  navbar-expand-lg navbar-light position-absolute">
            <div class="container position-relative">
                ...
                <a class="navbar-brand" href="/">
                    <img src="/assets/navbar/logo-long-dark.png" alt="" class="img-fluid" width="220px">
                </a>
                ...
                <div class="row text-center text-lg-left pb-70 pb-lg-0">
                    <div class="col-12 col-lg-6">
                        <div class="hero-content mb-35">
                            <h1 class="color-white mb-15" style="font-weight: bold">MoneyTrash<br>Trash Me! It's Work </h1>
                        ...
                        <div class="col-12 col-lg-5 hero-img pos-abs-bottom-right p-5 m-5 d-lg-none">
                            <span>
                                <img src="/assets/navbar/logo.png" alt="hero-image" class="img-fluid p-5 m-5" width="320px">
                            </span>
                        </div>
                    </div>
                    <!-- col-12 end -->
                    ...
                    <div class="col-12 col-lg-7 mx-auto">
                        <div class="text-center">
                            <a class="mb-25" href="index.html">
                                <img src="img/brand-logo-color.png" alt="">
                            </a>
